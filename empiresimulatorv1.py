...
while True:
                    ...
                    while True:
                        ...
                        if xq == "Storage":
                            ...
                            if xqs == "A":
                                ...
                                print("You have storaged the apples succesfully!")
                            if xqs == "C":
                              print("You found the easter egg!, I am Maurici one of the main creators of this game and I just want to make sure you are getting good at this game so send something to cristianorlmano@gmail.com to talk or something, bye!")
    ...
    if x == "Work":
      ...
      print("Narco ==> 30 seconds, 30000$ (50% win or 50% end game)")
      print(" ")
      ...
      if k == "McDonalds":
        ...
        if uo == 1:
          ...
          print("The police has caught you in the act, try harder next time")
          print("Game Over")
          break
